...
<div id="nav1"> <!--主菜单布局-->
	<ul>
	<li><a href="<?php echo site_url('admin_user')?>" target="main-frame" onClick="changeMenu('<?php echo site_url('frameset/menu/system');?>')">系统管理</a></li>
    <li><a class="tab-front"href="<?php echo site_url('computer/category')?>" target="main-frame" onClick="changeMenu('<?php echo site_url('frameset/menu/computer');?>')">监控面板</a></li>
	</ul>
</div>
<div id="admin">&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->session->userdata('name');?>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_top" href="<?php echo site_url('logout')?>">退出<a/></div>
