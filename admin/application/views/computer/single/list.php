...
$(document).ready(function() {
  $('#search-action').click(function(){
   var params=$('#search-form').serialize();
    $.ajax({ 
   		url:'<?php echo base_url()?>index.php/computer/single',
		type:'POST',
		data:params,
		success: update_page
   });
  ...
  function update_page (json)  //回传函数实体，参数为XMLhttpRequest.responseText
  {
	...
	var result = data.substring(index + 3, data.length-1);
	var str = new Array();
	str = result.split(",");
	//alert(data);
	//alert(str[0].length);
...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px;">
  ...
  <div style="position: relative;"  class="x-panel-bwrap">
	  ...
	  <tr class="x-grid3-row " >
      		<div style="width:700px;height:500px;text-align:center;margin:0 auto; margin-top:80px; " >        
