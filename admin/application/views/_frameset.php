...
<frameset border="0" framespacing="0" rows="35,*" >
    ...
    <frameset id="frame-body" border="0" framespacing="0" cols="230, *" name="frame-body">
		<frame scrolling="no" frameborder="no" name="menu-frame" id="menu-frame" src="<?php echo site_url('frameset/menu/system')?>"/>
		<frame scrolling="no" frameborder="no" name="main-frame" id="main-frame" src="<?php echo site_url('admin_user')?>"/>
    </frameset>
